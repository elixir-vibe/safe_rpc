...
The protocol term version is currently `1`. Unknown or malformed request/reply terms are rejected by the protocol decoder. Malformed frames and duplicate active request IDs close only the affected connection.
